...
void ui_LoadingPage_screen_init(void)
{
    ...
    lv_img_set_src(ui_Image6, &ui_img_polipharm_png);
    ...
    ui_Copyright1 = lv_label_create(ui_LoadingPage);
    lv_obj_set_width(ui_Copyright1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Copyright1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Copyright1, 0);
    lv_obj_set_y(ui_Copyright1, 142);
    lv_obj_set_align(ui_Copyright1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Copyright1, "CREATE BY NATTAPON PONDONKO");
    lv_obj_set_style_text_color(ui_Copyright1, lv_color_hex(0x808080), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Copyright1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Copyright1, &ui_font_sukhumvit25, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_LoadingLabel, &ui_font_sukhumvit30, LV_PART_MAIN | LV_STATE_DEFAULT);
